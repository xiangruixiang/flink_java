 ...
 * 批量数据存入Mysql
 */
public class SinkToMySQL_MyActivity extends RichSinkFunction<Results> {
...
/*
        ...
        */
        ...
        String sql = "replace into results(id, create_time, myname, salary) values(?, ?, ?, ?);";
    ...
    public void invoke(Results value, Context context) throws Exception {
       ...
       // for (Results employee : value) {
            ...
            ps.setString(2, value.getCreate_time());
            ps.setString(3, value.getMyname());
            ps.setInt(4, value.getSalary());
            ps.addBatch();
       // }
